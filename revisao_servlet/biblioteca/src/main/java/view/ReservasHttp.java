...
public class ReservasHttp extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String nome_Pessoa = obj.getString("nome_pessoa");
		String nome_Livro = obj.getString("nome_livro");
		String data = obj.getString("data_devolucao");
		
		Reservas reserva =  new Reservas();
		reserva.setNome_livro(nome_Livro);
		reserva.setNome_pessoa(nome_Pessoa);
