...
export default function Create({ navigation }) {
    ...
    var aluno = {} // variavel global pra ser constante

    // isnan = isso nao e um number --------------- nasciment odeixou com o formato do tamanho da data pra poder validar a data
    // else -- se nao tiver preenchido ira aparecer a msg de seterro
    // preenche o modelo do json 
    // *1 do peso e altura  --- vem de string ai ele multiplca por 1 
    // fetch colocar o tipo json  --- pra dar o post e o fetch
    const enviar = () => {
